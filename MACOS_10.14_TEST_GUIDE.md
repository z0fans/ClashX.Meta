...
### 1. 重新编译兼容内核 ⚠️ **关键修复**
- **问题**: 预编译的 mihomo 二进制都需要 x86-64-v3 指令集,在 macOS 10.14 虚拟机上无法运行
- **原版本**: v1.19.17 (需要 macOS 12.0+ 且需要 x86-64-v3) ❌
- **尝试降级**: v1.17.0/v1.18.0 预编译版本仍需 x86-64-v3 ❌
- **最终方案**: 使用 Go 1.19 重新编译 mihomo v1.13.2,禁用 x86-64-v3 要求 ✅
- **新版本**: Clash Meta v1.10.0 (从 v1.13.2 源码编译)
- **系统要求**: macOS 10.9+ (minos 10.9)
- **架构**: 纯 x86_64 (17MB uncompressed → 6.1MB compressed)
- **MD5**: `bf319c809796907c6cb64e6181089e5b`
